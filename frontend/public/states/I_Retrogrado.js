...
export default class I_Retrogrado extends Phaser.Scene
{
    create()
    {
    ...
    rStart(x,trial){
      ...
      this.tweens.add({
       ...
       yoyo: false,
       repeat: 0,});
      setTimeout(function(){ gameState.tTxt4.txt.destroy()}, 3000);
 eventos.puntos = gameState.score
